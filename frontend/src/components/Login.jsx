                                ...
                                <div className="col-lg-10 col-xl-10 mx-auto">
                                    ...
                                    <form className="">
                                        <div className="form-group mb-3">
                                            <input id="inputEmail" type="email" placeholder="Email address" required={true} autoFocus={true} className="form-control rounded-pill border-0 shadow-sm px-4" />
                                        </div>
                                        <div className="form-group mb-3">
                                        ...
                                        <div className="custom-control custom-checkbox mb-3">
                                            ...
                                            <label htmlFor="customCheck1" className="custom-control-label ms-2"> Remember password </label>
                                        </div>
                                        <button type="submit" className="btn btn-primary btn-block text-uppercase mb-2 rounded-pill shadow-sm w-100"> Sign in </button>

                                        <div className="text-center d-flex justify-content-between mt-4">
                                            <p> Don't have an account? <a href="#" className="font-italic text-muted"> <u> Sign up </u> </a> </p>
                                        </div>
